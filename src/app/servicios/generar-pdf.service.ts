...
import { DepartamentoService } from './departamentoservice/departamento.service';
...
export class GenerarPDFService {
  ...
  static titularDepto: string;
  //private static deptoServicio: DepartamentoService;
         ...
         table:{
           ...
           body:[
             [{ 
               ...
               text: depto.teldirecto+'   '+depto.ext+' '+depto.extt, 
               fontSize: 8, alignment: 'center', 
               border:[false, false, false, true] 
             }]
           ]
         ...
         table:{
           ...
           body:[
             [ {text: '______________________________',alignment: 'center'},
               ...
               {text: 'LIC. HORACIO VÁZQUEZ SOTO',fontSize: 8, alignment: 'center'},
         ...
         table:{
           ...
           body:[
             [ {text: '__________________________', alignment:'center', border:[true, false, false, false]},
               ...
               {text: 'MTRO. JORGE LUIS TREJO SOLÍS', fontSize: 8, alignment: 'center', border:[false, false, true, true]}
             ]
           ]
         }, margin: [0, 0, 0, 10]
       },{
          ...
          table:{
            ...
            body:[
              [ {
                ...
                { text:"LIC. HORACIO VÁZQUEZ SOTO", fontSize: 8, alignment: "center", border:[0,0,0,0] },
                { text:"", fontSize: 8, alignment: "center", border:[0,0,0,0] },
                { text:"MTRO. SIMÓN LÓPEZ ÁLVAREZ", fontSize: 8, alignment: "center", border:[1,0,0,1] },
                { text:"MTRO. JORGE ANDRÉS TREJO SOLÍS", fontSize: 8, alignment: "center", border:[0,0,1,1] }
              ]
            ]
          }
        },{
